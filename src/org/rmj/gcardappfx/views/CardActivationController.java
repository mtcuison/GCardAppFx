...
import org.rmj.gcard.trans.agentFX.XMGCardActivate;

public class CardActivationController implements Initializable {
    @FXML
    ...
    private final String pxeModuleName = "G-Card Activation";
    ...
    private XMGCardActivate poTrans;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        poTrans = new XMGCardActivate(poGRider ,psBranchCd);
    ...
    public void loadGui(){
        ...
        mainController.cmdButton02.setText("ACTIVATE");
    ...
    private void loadTransaction(){
        ...
        txtField03.setText(CommonUtils.xsDateMedium((Date) CommonUtils.toDate(pxeCurrentDate)));
        ...
        txtField07.setText(CommonUtils.xsDateMedium((Date) poTrans.getApplication(poTrans.getMaster("sGCardNox").toString().substring(0, 4)).getMaster("dTransact")));
            ...
            case "cmdbutton02":
                ...
                if (cmbCardClass.getSelectionModel().getSelectedIndex() == 0){
                    if(poTrans.activate()){
                        ...
                        ShowMessageFX.Information(null, pxeModuleName, "Successfully activated card!");
                        clearFields();
                    }else{
                        ShowMessageFX.Warning(null, pxeModuleName, poTrans.getMessage());
                    }
                }else{
                    if(poTrans.activateNonChip()){
                        ShowMessageFX.Information(null, pxeModuleName, "Successfully activated card!");
                        clearFields();
                    }else{
                        ShowMessageFX.Warning(null, pxeModuleName, poTrans.getMessage());
