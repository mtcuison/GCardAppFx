...
public class OfflinePoints_EntryBController implements Initializable {
    ...
    private void cmdButton_Click(ActionEvent event) {
        ...
        switch (lsButton){
            ...
            case "cmdbutton02":
                ...
                break;
            case "cmdbutton03":
                mainController.loadModule(pxeOfflinePoints_Register);
                break;
            case "cmdbutton04": 
            case "cmdbutton05":
            case "cmdbutton06":
    ...
    public void loadTransaction(){
        ...
        txtField06.setText(""); //wala naman talagang value ito kaya empty
        ...
        setTransTat(String.valueOf(poTrans.getMaster("cTranStat")));
    ...
    public void clearFields() {
        ...
        txtField03.setText("");
        txtField04.setText("N-O-N-E");
        txtField05.setText(CommonUtils.xsDateMedium((Date) CommonUtils.toDate(pxeCurrentDate)));
        txtField06.setText("");
