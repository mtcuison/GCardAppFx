...
import static org.rmj.gcardappfx.views.GCardAppFxController.pxeOfflinePoints_Entry;


public class OfflinePoints_RegisterMController implements Initializable {
    ...
    private void iniTransaction(){
        ...
        txtSeeks02.setText((String) poTrans.getBranch().getMaster("sBranchNm"));
        ...
        switch (lsButton){
            ...
            case "cmdbutton01":
                switch (pnIndex){
                    case 0:
                        ...
                        if (poTrans.searchWithCondition("sClientNm", txtSeeks00.getText(), "a.sTransNox LIKE " + SQLUtil.toSQL(psBranch+ '%')+"") == true){
                            loadTransaction();
                        }else{
                    ...
                    case 1:
                        ...
                        if (poTrans.searchWithCondition("sSourceNo", txtSeeks01.getText(), "a.sTransNox LIKE " + SQLUtil.toSQL(psBranch+ '%')+"") == true){
                            loadTransaction();
                        }else{
                            ShowMessageFX.Information(null, "Notice", poTrans.getMessage());
                            mainController.setFocus(txtSeeks01);
                        ...
                        break;
                    case 2:
                        if (poTrans.searchField("sBranchNm", txtSeeks02.getText()) == true){
                            clearFields();
                        }else{
                            ShowMessageFX.Information(null, "Notice", poTrans.getMessage());
            ...
            case "cmdbutton02":
             ...
             case "cmdbutton03":
                ...
                break;
             case "cmdbutton04":
                mainController.loadModule(pxeOfflinePoints_Entry);
                break;
            case "cmdbutton05":
            case "cmdbutton06":
            case "cmdbutton07":
    ...
    public void initButton(int fnValue) {
       ...
       if (lbShow) mainController.setFocus(txtSeeks02);
        ...
        if (event.getCode() == ENTER || event.getCode() == KeyCode.F3) {
                switch (lnIndex){
                    case 0:
                        ...
                        if (poTrans.searchWithCondition("sClientNm", lsValue, "a.sTransNox LIKE " + SQLUtil.toSQL(psBranch+ '%')+"") == true){
                            loadTransaction();
                        }else{
                            ShowMessageFX.Information(null, "Notice", poTrans.getMessage());
                            return;
                    ...
                    case 1:
                        ...
                        if (poTrans.searchWithCondition("sSourceNo", lsValue, "a.sTransNox LIKE " + SQLUtil.toSQL(psBranch+ '%')+"") == true){
                            loadTransaction();
                        }else{
                            ShowMessageFX.Information(null, "Notice", poTrans.getMessage());
                            return;
