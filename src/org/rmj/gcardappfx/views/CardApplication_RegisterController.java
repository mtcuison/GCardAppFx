...
public class CardApplication_RegisterController implements Initializable {
        ...
        switch (lsButton){
            ...
            case "cmdbutton01":
                switch (pnIndex){
                    ...
                    case 2:
                        ...
                        if (poTrans.SearchWithCondition("sSourceNo", txtSeeks02.getText(), "")==true){
                            loadTransaction();
                        }else{
                            ShowMessageFX.Information(null, "Notice", poTrans.getMessage());
            ...
            case "cmdbutton03":
                if(ShowMessageFX.OkayCancel(null, pxeModuleName, "Do you want to cancel this application?")== true){
                 ...
                 break;
            case "cmdbutton04":
                new XMGCConnect(poGRider).Disconnect();
                mainController.loadModule(pxeCardApplication);
                break;
            case "cmdbutton05":
            case "cmdbutton06":
            case "cmdbutton07":
